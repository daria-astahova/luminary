...
FClassRegistrationInfo Z_Registration_Info_UClass_UTouchInputGetK2Node;
UClass* UTouchInputGetK2Node::GetPrivateStaticClass()
{
	using TClass = UTouchInputGetK2Node;
	if (!Z_Registration_Info_UClass_UTouchInputGetK2Node.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("TouchInputGetK2Node"),
			Z_Registration_Info_UClass_UTouchInputGetK2Node.InnerSingleton,
			StaticRegisterNativesUTouchInputGetK2Node,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UTouchInputGetK2Node.InnerSingleton;
}
UClass* Z_Construct_UClass_UTouchInputGetK2Node_NoRegister()
{
	return UTouchInputGetK2Node::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngineEditor_Private_Nodes_TouchInputGetK2Node_h__Script_TouchEngineEditor_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UTouchInputGetK2Node, UTouchInputGetK2Node::StaticClass, TEXT("UTouchInputGetK2Node"), &Z_Registration_Info_UClass_UTouchInputGetK2Node, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTouchInputGetK2Node), 2051101793U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngineEditor_Private_Nodes_TouchInputGetK2Node_h__Script_TouchEngineEditor_1475940476(TEXT("/Script/TouchEngineEditor"),
	Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngineEditor_Private_Nodes_TouchInputGetK2Node_h__Script_TouchEngineEditor_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngineEditor_Private_Nodes_TouchInputGetK2Node_h__Script_TouchEngineEditor_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
